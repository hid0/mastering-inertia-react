...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      >
        <svg
          className="fill-current dark:hidden text-gray-500/80 dark:text-gray-400/80"
          width={16}
          height={16}
          viewBox="0 0 16 16"
        ...
        <svg
          className="hidden fill-current dark:block text-gray-500/80 dark:text-gray-400/80"
          width={16}
          height={16}
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
