        ...
        >
          ...
          <div className="px-2 py-4">
            ...
            <div className="mb-3 last:mb-0">
              <div className="px-2 mb-2 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">Recent searches</div>
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="px-2 mb-2 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">Recent pages</div>
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-gray-800 rounded-lg dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/20"
