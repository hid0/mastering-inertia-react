    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="ml-2 text-sm font-medium text-gray-600 truncate dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">Acme Inc.</span>
          <svg className="w-3 h-3 ml-1 text-gray-400 fill-current shrink-0 dark:text-gray-500" viewBox="0 0 12 12">
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            ...
            <div className="text-xs italic text-gray-500 dark:text-gray-400">Administrator</div>
          </div>
          <ul>
            <li>
              <Link
