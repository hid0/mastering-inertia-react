...
function DateSelect() {
  ...
  return (
    <div className="relative">
      <button
        ref={trigger}
        className="justify-between text-gray-600 bg-white border-gray-200 btn min-w-44 dark:bg-gray-800 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100"
      ...
      >
        <span className="flex items-center">
          <svg className="mr-2 text-gray-400 fill-current dark:text-gray-500 shrink-0" width="16" height="16" viewBox="0 0 16 16">
            <path d="M5 4a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2H5Z" />
            <path d="M4 0a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V4a4 4 0 0 0-4-4H4ZM2 4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4Z" />
          </svg>
          <span>{options[selected].period}</span>
        </span>
        <svg className="ml-1 text-gray-400 fill-current shrink-0 dark:text-gray-500" width="11" height="7" viewBox="0 0 11 7">
