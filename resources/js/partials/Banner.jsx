    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 z-50 w-full md:bottom-8 md:right-12 md:w-auto">
          <div className="flex justify-between p-3 text-sm bg-gray-800 border border-transparent shadow-lg dark:border-gray-700/60 text-gray-50 md:rounded">
            <div className='inline-flex text-gray-500'><a className="font-medium hover:underline text-gray-50" href={liteLink} target="_blank" rel="noreferrer">Download<span className="hidden sm:inline"> on GitHub</span></a> <span className="italic px-1.5">or</span> <a className="font-medium hover:underline text-emerald-400" href="https://cruip.com/mosaic/" target="_blank" rel="noreferrer">Check Premium Version</a></div>
            <button className="pl-2 ml-3 text-gray-500 border-l hover:text-gray-400 border-gray-700/60" onClick={() => setBannerOpen(false)}>
